...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', # Connect CORS middleware
...
# Custom user model
AUTH_USER_MODEL = 'saikialaundry.user'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'cmind8574@gmail.com'
EMAIL_HOST_PASSWORD = 'uboe rksu dfqj rdiu'
DEFAULT_FROM_EMAIL = 'cmind8574@gmail.com'
